<%-- 
    Document   : Consultar expediente
    Created on : 17-abril-2016, 21:21:03
    Author     : Sergio
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading"> Buscar expediente por CURP</div>

                                <form class="form-inline" name="consultarExp" action="Expediente.jsp" method="get">
                                    <br>
                                    <div class="form-group">
                                    <label>CURP del paciente: </label>
                                    <input class="form-control" type="text" name="curpPaciente" placeholder="CURP">
                                    </div>
                                    <button class="btn btn-primary" type="submit"/> Consultar expediente </button>
