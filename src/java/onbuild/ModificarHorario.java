...
public class ModificarHorario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            conex.actualizarHorario(lunes, martes, miercoles, jueves, viernes, sabado, cedula);
            response.sendRedirect("ModificarTerapeuta.jsp?cedula="+cedula);
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ModificarHorario</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Actualización de horario </h1>");
            out.println("</body>");
            out.println("</html>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ModificarHorario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
